...
// AzureAppInsightsExecutor executes queries for the App Insights datasource
type AzureAppInsightsExecutor struct {
	httpClient *http.Client
	dsInfo     *models.DataSource
}

// NewAzureAppInsightsExecutor initializes a http client
func NewAzureAppInsightsExecutor(dsInfo *models.DataSource) (tsdb.TsdbQueryEndpoint, error) {
	httpClient, err := dsInfo.GetHttpClient()
	if err != nil {
		return nil, err
	}

	return &AzureAppInsightsExecutor{
...
func init() {
	...
	tsdb.RegisterTsdbQueryEndpoint("stackdriver", NewAzureAppInsightsExecutor)
	legendKeyFormat = regexp.MustCompile(`\{\{\s*(.+?)\s*\}\}`)
	metricNameFormat = regexp.MustCompile(`([\w\d_]+)\.googleapis\.com/(.+)`)
}

// Query takes in the frontend queries and executes the queries against the Azure App Insights API and
// parses the response into
// the time series or table format
func (e *AzureAppInsightsExecutor) Query(ctx context.Context, dsInfo *models.DataSource, tsdbQuery *tsdb.TsdbQuery) (*tsdb.Response, error) {
	...
	switch queryType {
	/*
	do annotation queries later... need to fully understand them later.
...
func (e *AzureAppInsightsExecutor) executeTimeSeriesQuery(ctx context.Context, tsdbQuery *tsdb.TsdbQuery) (*tsdb.Response, error) {
...
func (e *AzureAppInsightsExecutor) buildQueries(tsdbQuery *tsdb.TsdbQuery) ([]*StackdriverQuery, error) {
...
func (e *AzureAppInsightsExecutor) executeQuery(ctx context.Context, query *StackdriverQuery, tsdbQuery *tsdb.TsdbQuery) (*tsdb.QueryResult, StackdriverResponse, error) {
...
func (e *AzureAppInsightsExecutor) unmarshalResponse(res *http.Response) (StackdriverResponse, error) {
...
func (e *AzureAppInsightsExecutor) parseResponse(queryRes *tsdb.QueryResult, data StackdriverResponse, query *StackdriverQuery) error {
...
func (e *AzureAppInsightsExecutor) createRequest(ctx context.Context, dsInfo *models.DataSource) (*http.Request, error) {
...
func (e *AzureAppInsightsExecutor) getDefaultProject(ctx context.Context) (string, error) {
	authenticationType := e.dsInfo.JsonData.Get("authenticationType").MustString(jwtAuthentication)
	if authenticationType == gceAuthentication {
